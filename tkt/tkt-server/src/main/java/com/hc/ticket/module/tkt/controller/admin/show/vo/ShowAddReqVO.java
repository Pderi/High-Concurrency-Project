...
@Schema(description = "管理端 - 演出新增 Request VO")
@Data
public class ShowAddReqVO {
    ...
    @Schema(description = "状态：0草稿 1已发布 2已下架", requiredMode = REQUIRED, example = "0")
    @NotNull(message = "状态不能为空")
    private Integer status;

    @Schema(description = "列表排序，越大越靠前", example = "0")
